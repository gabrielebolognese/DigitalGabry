...
**Current phase: 1, tokens and app shell.** Update this line when a phase merges. One branch per phase named `phase-NN-slug`, one commit, and a cleared context before the next one.
