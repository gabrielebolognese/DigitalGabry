...
**Current phase: 6, recurrence, scheduler, quick capture.** Update this line when a phase merges. One branch per phase named `phase-NN-slug`, one commit, and a cleared context before the next one.
